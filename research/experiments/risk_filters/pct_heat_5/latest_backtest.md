...
Generated: `2026-05-08T16:55:30Z`
Strategy: `l5_mvp_conservative_v1`
Samples: `520`
Production samples: `520`
Promotable samples: `520`
Sample quality: `sufficient`
Strict samples: `520`
Relaxed samples: `0`
Qualified samples: `520`
Symbol risk mode: `point_in_time`
Symbol risk point-in-time: `True`
Experimental risk filter: `pct_heat_5`
...
Average net return: `1.027`%
Win rate: `0.538`
Default benchmark: `2800.HK`
CN benchmark: `510300.SH`
Average benchmark alpha: `0.616`%
Average max adverse return: `-2.631`%
Max adverse-ish return: `-35.257`%
Adverse breach rate: `0.09`
...
## Market Family Risk
- `hk`: samples=307, win=0.596, avg=1.487%, alpha=0.794%, max_adverse=-35.257%, breach_rate=0.091
- `cn`: samples=213, win=0.455, avg=0.363%, alpha=0.359%, max_adverse=-18.829%, breach_rate=0.089
...
- `0_85_to_1_00`: samples=400, breaches=32, breach_rate=0.08, max_adverse=-19.735%
- `0_70_to_0_85`: samples=70, breaches=5, breach_rate=0.071, max_adverse=-18.829%
### `volume_ratio_20`
- `gte_2_50`: samples=18, breaches=3, breach_rate=0.167, max_adverse=-14.458%
- `1_00_to_1_50`: samples=343, breaches=36, breach_rate=0.105, max_adverse=-35.257%
- `1_50_to_2_50`: samples=159, breaches=8, breach_rate=0.05, max_adverse=-16.647%
### `pct_change_1d`
- `neg_2_to_0`: samples=79, breaches=8, breach_rate=0.101, max_adverse=-18.599%
- `0_to_2`: samples=219, breaches=22, breach_rate=0.1, max_adverse=-18.176%
- `2_to_5`: samples=222, breaches=17, breach_rate=0.077, max_adverse=-35.257%
### `market_range_pos_60`
- `0_50_to_0_70`: samples=239, breaches=24, breach_rate=0.1, max_adverse=-18.599%
- `lt_0_30`: samples=154, breaches=13, breach_rate=0.084, max_adverse=-35.257%
- `0_30_to_0_50`: samples=127, breaches=10, breach_rate=0.079, max_adverse=-18.829%
