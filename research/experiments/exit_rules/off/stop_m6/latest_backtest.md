...
Generated: `2026-05-09T04:19:20Z`
...
Average net return: `0.922`%
Win rate: `0.519`
Default benchmark: `2800.HK`
CN benchmark: `510300.SH`
Average benchmark alpha: `0.522`%
Average max adverse return: `-2.523`%
Max adverse-ish return: `-14.934`%
Adverse breach rate: `0.058`
...
## Market Family Risk
- `hk`: samples=327, win=0.56, avg=1.012%, alpha=0.369%, max_adverse=-14.934%, breach_rate=0.073
- `cn`: samples=224, win=0.46, avg=0.79%, alpha=0.746%, max_adverse=-10.641%, breach_rate=0.036
...
### `range_pos_60`
- `0_35_to_0_70`: samples=53, breaches=8, breach_rate=0.151, max_adverse=-13.116%
- `0_85_to_1_00`: samples=426, breaches=23, breach_rate=0.054, max_adverse=-14.934%
- `0_70_to_0_85`: samples=72, breaches=1, breach_rate=0.014, max_adverse=-10.307%
### `volume_ratio_20`
- `gte_2_50`: samples=37, breaches=8, breach_rate=0.216, max_adverse=-11.747%
- `1_00_to_1_50`: samples=341, breaches=17, breach_rate=0.05, max_adverse=-14.934%
- `1_50_to_2_50`: samples=173, breaches=7, breach_rate=0.04, max_adverse=-13.116%
### `pct_change_1d`
- `gte_5`: samples=67, breaches=11, breach_rate=0.164, max_adverse=-13.116%
- `neg_2_to_0`: samples=75, breaches=5, breach_rate=0.067, max_adverse=-11.747%
- `0_to_2`: samples=202, breaches=9, breach_rate=0.045, max_adverse=-14.934%
- `2_to_5`: samples=207, breaches=7, breach_rate=0.034, max_adverse=-10.865%
### `market_range_pos_60`
- `0_50_to_0_70`: samples=258, breaches=19, breach_rate=0.074, max_adverse=-14.934%
- `lt_0_30`: samples=155, breaches=8, breach_rate=0.052, max_adverse=-10.355%
- `0_30_to_0_50`: samples=138, breaches=5, breach_rate=0.036, max_adverse=-10.865%
