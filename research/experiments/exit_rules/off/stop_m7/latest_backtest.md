...
Generated: `2026-05-09T04:19:34Z`
...
Average net return: `0.857`%
Win rate: `0.521`
Default benchmark: `2800.HK`
CN benchmark: `510300.SH`
Average benchmark alpha: `0.451`%
Average max adverse return: `-2.651`%
Max adverse-ish return: `-15.763`%
Adverse breach rate: `0.082`
...
## Market Family Risk
- `hk`: samples=327, win=0.563, avg=0.987%, alpha=0.312%, max_adverse=-14.934%, breach_rate=0.098
- `cn`: samples=224, win=0.46, avg=0.667%, alpha=0.655%, max_adverse=-15.763%, breach_rate=0.058
...
### `range_pos_60`
- `0_35_to_0_70`: samples=53, breaches=11, breach_rate=0.208, max_adverse=-13.116%
- `0_85_to_1_00`: samples=426, breaches=31, breach_rate=0.073, max_adverse=-15.763%
- `0_70_to_0_85`: samples=72, breaches=3, breach_rate=0.042, max_adverse=-12.863%
### `volume_ratio_20`
- `gte_2_50`: samples=37, breaches=8, breach_rate=0.216, max_adverse=-11.747%
- `1_00_to_1_50`: samples=341, breaches=27, breach_rate=0.079, max_adverse=-14.934%
- `1_50_to_2_50`: samples=173, breaches=10, breach_rate=0.058, max_adverse=-15.763%
### `pct_change_1d`
- `gte_5`: samples=67, breaches=13, breach_rate=0.194, max_adverse=-13.116%
- `neg_2_to_0`: samples=75, breaches=6, breach_rate=0.08, max_adverse=-15.763%
- `0_to_2`: samples=202, breaches=14, breach_rate=0.069, max_adverse=-14.934%
- `2_to_5`: samples=207, breaches=12, breach_rate=0.058, max_adverse=-15.188%
### `market_range_pos_60`
- `0_50_to_0_70`: samples=258, breaches=24, breach_rate=0.093, max_adverse=-15.763%
- `0_30_to_0_50`: samples=138, breaches=11, breach_rate=0.08, max_adverse=-12.863%
- `lt_0_30`: samples=155, breaches=10, breach_rate=0.065, max_adverse=-12.666%
