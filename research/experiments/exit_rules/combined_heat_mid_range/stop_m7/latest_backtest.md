...
Generated: `2026-05-09T04:20:46Z`
...
Average benchmark alpha: `0.538`%
Average max adverse return: `-2.356`%
...
## Market Family Risk
- `hk`: samples=277, win=0.585, avg=1.289%, alpha=0.541%, max_adverse=-14.934%, breach_rate=0.054
- `cn`: samples=196, win=0.454, avg=0.383%, alpha=0.533%, max_adverse=-15.763%, breach_rate=0.046
...
- `2025-01-03` `9992.HK` (hk): net=-10.692%, adverse=-10.342%, range=0.9736, volume=1.2004, pct_1d=3.379
- `2024-09-02` `0386.HK` (hk): net=-10.57%, adverse=-10.22%, range=0.8788, volume=1.3243, pct_1d=0.204

## Adverse Driver Buckets
### `range_pos_60`
- `0_85_to_1_00`: samples=393, breaches=21, breach_rate=0.053, max_adverse=-15.763%
- `0_70_to_0_85`: samples=80, breaches=3, breach_rate=0.037, max_adverse=-12.863%
### `volume_ratio_20`
- `1_00_to_1_50`: samples=323, breaches=19, breach_rate=0.059, max_adverse=-14.934%
- `1_50_to_2_50`: samples=149, breaches=5, breach_rate=0.034, max_adverse=-15.763%
- `gte_2_50`: samples=1, breaches=0, breach_rate=0.0, max_adverse=-1.09%
### `pct_change_1d`
- `neg_2_to_0`: samples=83, breaches=5, breach_rate=0.06, max_adverse=-15.763%
- `0_to_2`: samples=206, breaches=12, breach_rate=0.058, max_adverse=-14.934%
- `2_to_5`: samples=184, breaches=7, breach_rate=0.038, max_adverse=-15.188%
### `market_range_pos_60`
- `0_30_to_0_50`: samples=120, breaches=8, breach_rate=0.067, max_adverse=-12.863%
- `0_50_to_0_70`: samples=219, breaches=10, breach_rate=0.046, max_adverse=-15.763%
- `lt_0_30`: samples=134, breaches=6, breach_rate=0.045, max_adverse=-12.666%
