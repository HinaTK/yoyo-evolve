...
Generated: `2026-05-09T04:20:32Z`
...
Average benchmark alpha: `0.654`%
Average max adverse return: `-2.209`%
Max adverse-ish return: `-14.934`%
Adverse breach rate: `0.025`
...
## Market Family Risk
- `hk`: samples=277, win=0.585, avg=1.38%, alpha=0.654%, max_adverse=-14.934%, breach_rate=0.032
- `cn`: samples=196, win=0.454, avg=0.552%, alpha=0.653%, max_adverse=-10.641%, breach_rate=0.015
...
### `range_pos_60`
- `0_85_to_1_00`: samples=393, breaches=12, breach_rate=0.031, max_adverse=-14.934%
- `0_70_to_0_85`: samples=80, breaches=0, breach_rate=0.0, max_adverse=-7.59%
### `volume_ratio_20`
- `1_00_to_1_50`: samples=323, breaches=10, breach_rate=0.031, max_adverse=-14.934%
- `1_50_to_2_50`: samples=149, breaches=2, breach_rate=0.013, max_adverse=-10.641%
- `gte_2_50`: samples=1, breaches=0, breach_rate=0.0, max_adverse=-1.09%
### `pct_change_1d`
- `neg_2_to_0`: samples=83, breaches=4, breach_rate=0.048, max_adverse=-11.127%
- `0_to_2`: samples=206, breaches=6, breach_rate=0.029, max_adverse=-14.934%
- `2_to_5`: samples=184, breaches=2, breach_rate=0.011, max_adverse=-8.857%
### `market_range_pos_60`
- `lt_0_30`: samples=134, breaches=4, breach_rate=0.03, max_adverse=-9.642%
- `0_50_to_0_70`: samples=219, breaches=6, breach_rate=0.027, max_adverse=-14.934%
